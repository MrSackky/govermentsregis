...
import { Layout, Menu, Button, Row, Col, Breadcrumb, PageHeader } from 'antd';
/* Components */
      ...
      <Layout>
        ...
        <Row>
          ...
          <Col  span={3} style={{ backgroundColor: "#ffffff" }}>
            {user.type_user == 1 &&
              <MenuSuperAdmin index={index} props={props} indexMenu={indexMenu} />
            }
            {user.type_user == 2 &&
              <MenuAdmin indexMenu={indexMenu} />
            }
            {/* <a
                  ...
                  {isMain && <>
                    <Col span={12} className="">
                      ...
                      <Row className="p-1.5 items-center">
                        ...
                        <h1 className="ml-4 mt-4 text-4xl">{titlePage}</h1>
                      </Row>
                    </Col>
